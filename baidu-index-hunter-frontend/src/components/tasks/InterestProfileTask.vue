<template>
  <div class="task-container">
    <div class="task-header">
      <h2>兴趣分析采集</h2>
      <div class="task-desc">获取百度指数人群兴趣画像数据，包含兴趣类别及其比例</div>
    </div>
    ...
    <el-card class="task-card">
      ...
      <el-form :model="formData" label-width="120px" class="task-form">
        ...
        <!-- 兴趣设置 -->
        <el-divider content-position="left">兴趣设置</el-divider>
        ...
        <el-form-item label="兴趣类型">
          <el-select
            ...
            style="width: 100%"
          >
            <el-option label="综合兴趣" value="general" />
            <el-option label="电商消费" value="ecommerce" />
            <el-option label="APP偏好" value="app" />
          </el-select>
        </el-form-item>
