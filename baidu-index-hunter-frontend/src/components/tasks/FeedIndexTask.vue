<template>
  <div class="task-container">
    <div class="task-header">
      <h2>{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-1") }}</h2>
      <div class="task-desc">
        {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-2") }}
      </div>
    </div>
    <el-card class="task-card"
      ><template #header
        ><div class="card-header">
          <span>{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-3") }}</span>
        </div></template
      >
      <el-form :model="formData" label-width="120px" class="task-form"
        ><!-- 关键词设置 -->
        <el-divider content-position="left">{{
          $t("tasks-FeedIndexTask-19c298e1d0a206148-4")
        }}</el-divider>
        <el-form-item :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-5')"
          ><el-input
            v-model="batchKeywords"
            type="textarea"
            :rows="4"
            :placeholder="$t('tasks-FeedIndexTask-19c298e1d0a206148-6')"
          />
          <div class="keywords-actions">
            <el-button
              ...
              {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-7") }}</el-button
            >
            <span class="keywords-tip">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-8")
            }}</span>
          </div></el-form-item
        >
        <el-form-item :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-9')"
          ><el-upload
            class="upload-area"
            action="#"
            :auto-upload="false"
            ...
            ><el-button type="primary"
              ...
              {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-10") }}</el-button
            >
            <div class="upload-tip">
              {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-11") }}
            </div></el-upload
          >
          <div class="file-import-options">
            <el-checkbox v-model="skipFirstLine">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-12")
            }}</el-checkbox>
          </div></el-form-item
        >
        <el-form-item
          :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-13')"
          ...
          ><div class="keywords-tags-container">
            <div class="keywords-tags">
              <el-tag
                ...
                <el-tooltip
                  ...
                  :content="$t('tasks-FeedIndexTask-19c298e1d0a206148-14')"
                  placement="top"
            ...
            <div class="keywords-actions">
              <el-button type="danger" plain size="small" @click="clearKeywords"
                ...
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-15") }}</el-button
              >
              <el-button
                type="primary"
                size="small"
                ...
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-16") }}</el-button
              >
              <el-button
                type="warning"
                plain
                ...
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-17") }}</el-button
              >
              <div class="keywords-count">
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-18") }}
                {{ formData.keywords.length }}
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-19") }}
              </div>
            </div>
          </div></el-form-item
        >
        <!-- 城市设置 -->
        <el-divider content-position="left">{{
          $t("tasks-FeedIndexTask-19c298e1d0a206148-20")
        }}</el-divider>
        <el-form-item :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-21')"
          ><RegionCitySelector
            v-model="selectedCities"
            :api-base-url="API_BASE_URL"
            @change="handleCitiesChange"
        /></el-form-item>
        <el-form-item :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-22')"
          ><el-upload
            class="upload-area"
            action="#"
            :auto-upload="false"
            ...
            ><el-button type="primary"
              ><el-icon><Upload /></el-icon>
              {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-23") }}</el-button
            >
            <div class="upload-tip">
              {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-24") }}
            </div></el-upload
          >
          <div class="file-import-options">
            <el-checkbox v-model="skipFirstLineForCities">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-25")
            }}</el-checkbox>
          </div></el-form-item
        >
        <!-- 时间设置 -->
        ...
        <el-form-item :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-30')"
          ><el-radio-group v-model="timeType"
            ><el-radio-button label="all">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-31")
            }}</el-radio-button>
            <el-radio-button label="custom">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-32")
            }}</el-radio-button>
            <el-radio-button label="preset">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-33")
            }}</el-radio-button>
            <el-radio-button label="year">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-34")
            }}</el-radio-button></el-radio-group
          ></el-form-item
        >
        <el-form-item
          :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-35')"
          v-if="timeType === 'custom'"
          ><el-date-picker
            v-model="dateRange"
            type="daterange"
            :range-separator="$t('tasks-FeedIndexTask-19c298e1d0a206148-36')"
            :start-placeholder="$t('tasks-FeedIndexTask-19c298e1d0a206148-37')"
            :end-placeholder="$t('tasks-FeedIndexTask-19c298e1d0a206148-38')"
            format="YYYY-MM-DD"
        ...
        /></el-form-item>
        <el-form-item
          :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-39')"
          v-if="timeType === 'preset'"
          ><el-select
            v-model="formData.days"
            :placeholder="$t('tasks-FeedIndexTask-19c298e1d0a206148-40')"
            style="width: 100%"
            ><el-option
              :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-41')"
              :value="7" />
            <el-option
              :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-42')"
              :value="30" />
            <el-option
              :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-43')"
              :value="90" />
            <el-option
              :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-44')"
              :value="180" /></el-select
        ></el-form-item>
        <el-form-item
          :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-45')"
          v-if="timeType === 'year'"
          ><div class="year-range">
            <el-date-picker
              v-model="formData.yearRange[0]"
              type="year"
              :placeholder="$t('tasks-FeedIndexTask-19c298e1d0a206148-46')"
              format="YYYY"
              value-format="YYYY"
              :disabled-date="disabledYearStart"
            />
            <span class="range-separator">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-47")
            }}</span>
            <el-date-picker
              v-model="formData.yearRange[1]"
              type="year"
              :placeholder="$t('tasks-FeedIndexTask-19c298e1d0a206148-48')"
              format="YYYY"
              value-format="YYYY"
        ...
        <el-form-item :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-55')"
          ><el-switch
            v-model="formData.resume"
            :active-text="$t('tasks-FeedIndexTask-19c298e1d0a206148-56')"
            :inactive-text="$t('tasks-FeedIndexTask-19c298e1d0a206148-57')"
        /></el-form-item>
        <el-form-item
          :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-58')"
          v-if="formData.resume"
          ><el-input
            v-model="formData.taskId"
            :placeholder="$t('tasks-FeedIndexTask-19c298e1d0a206148-59')"
        /></el-form-item>
        <el-form-item :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-60')"
          ><el-slider
        ...
        <el-form-item
          ><el-button
            ...
            size="large"
            ><el-icon><Check /></el-icon>
            {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-61") }}</el-button
          >
          <el-button @click="resetForm" size="large"
            ><el-icon><Refresh /></el-icon>
            {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-62") }}</el-button
          ></el-form-item
        ></el-form
      ></el-card
    >
    <el-dialog
      ...
      :title="$t('tasks-FeedIndexTask-19c298e1d0a206148-63')"
      width="500px"
      ><div class="success-content">
        <el-result
          icon="success"
          :title="$t('tasks-FeedIndexTask-19c298e1d0a206148-64')"
          :sub-title="`${$t('tasks-FeedIndexTask-19c298e1d0a206148-65')}${taskId}`"
          ><template #extra
            ><el-button type="primary" @click="goToTaskList">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-66")
            }}</el-button>
            <el-button @click="successDialogVisible = false">{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-67")
            }}</el-button></template
          ></el-result
        >
      </div></el-dialog
    ...
    <el-dialog
      ...
      :title="$t('tasks-FeedIndexTask-19c298e1d0a206148-68')"
      width="500px"
      modal
      append-to-body
      ...
      ><div class="check-result-content">
        <el-alert
          ...
          type="success"
          :title="`${checkResults.existsCount}${$t('tasks-FeedIndexTask-19c298e1d0a206148-69')}`"
          :closable="false"
          show-icon
        />
        <el-alert
          ...
          type="warning"
          :title="`${checkResults.notExistsCount}${$t('tasks-FeedIndexTask-19c298e1d0a206148-70')}`"
          :closable="false"
          show-icon
          style="margin-top: 10px"
        />
        <div v-if="checkResults.notExistsCount > 0" class="invalid-keywords">
          <p>{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-71") }}</p>
      ...
      <template #footer
        ><span class="dialog-footer"
          ><el-button @click="checkResultDialogVisible = false">{{
            $t("tasks-FeedIndexTask-19c298e1d0a206148-72")
          }}</el-button>
          <el-button
            type="warning"
            @click="removeInvalidKeywordsFromDialog"
            :disabled="checkResults.notExistsCount === 0"
            >{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-73") }}</el-button
          ></span
        ></template
      ></el-dialog
    >
    ...
    <el-dialog
      ...
      ><div class="import-result-content">
        <el-alert
          ...
          type="success"
          :title="`${$t('tasks-FeedIndexTask-19c298e1d0a206148-74')} ${importResults.validItems.length}${importResultTitle === $t('tasks-FeedIndexTask-19c298e1d0a206148-75') ? $t('tasks-FeedIndexTask-19c298e1d0a206148-76') : $t('tasks-FeedIndexTask-19c298e1d0a206148-77')}`"
          :closable="false"
          show-icon
        />
        <el-alert
          ...
          type="warning"
          :title="`${importResults.invalidItems.length} ${importResultTitle === $t('tasks-FeedIndexTask-19c298e1d0a206148-79') ? $t('tasks-FeedIndexTask-19c298e1d0a206148-80') : $t('tasks-FeedIndexTask-19c298e1d0a206148-81')}${$t('tasks-FeedIndexTask-19c298e1d0a206148-78')}`"
          :closable="false"
          show-icon
          style="margin-top: 10px"
        />
        ...
        >
          <p>
            {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-82") }}
            {{
              importResultTitle ===
              $t("tasks-FeedIndexTask-19c298e1d0a206148-83")
                ? $t("tasks-FeedIndexTask-19c298e1d0a206148-84")
                : $t("tasks-FeedIndexTask-19c298e1d0a206148-85")
            }}
            ：
          </p>
          <div class="keywords-list">
            ...
            <el-tag v-if="importResults.invalidItems.length > 20" type="info"
              >{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-86") }}
              {{ importResults.invalidItems.length - 20 }}
              {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-87") }}</el-tag
            >
          </div>
        </div>
      </div>
      <template #footer
        ><span class="dialog-footer"
          ><el-button @click="importResultDialogVisible = false">{{
            $t("tasks-FeedIndexTask-19c298e1d0a206148-88")
          }}</el-button></span
        ></template
      ></el-dialog
    >
    ...
    <el-dialog
      ...
      :title="$t('tasks-FeedIndexTask-19c298e1d0a206148-89')"
      width="600px"
      :close-on-click-modal="false"
      ><div class="task-overview">
        <el-descriptions
          :title="$t('tasks-FeedIndexTask-19c298e1d0a206148-90')"
          :column="1"
          border
          ><el-descriptions-item
            :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-91')"
            ><el-tag>{{
              $t("tasks-FeedIndexTask-19c298e1d0a206148-92")
            }}</el-tag></el-descriptions-item
          >
          <el-descriptions-item
            :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-93')"
            ><div class="overview-keywords">
              <span class="overview-count"
                >{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-94") }}
                {{ formData.keywords.length }}
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-95") }}</span
              >
              <div class="overview-tags">
                ...
                <el-tag
                  ...
                  type="info"
                  size="small"
                  >{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-96") }}
                  {{ formData.keywords.length - 10 }}
                  {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-97") }}</el-tag
                >
              </div>
            </div></el-descriptions-item
          >
          <el-descriptions-item
            :label="$t('tasks-FeedIndexTask-19c298e1d0a206148-98')"
            ><div class="overview-cities">
              <span class="overview-count"
                >{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-99") }}
          ...
          <el-descriptions-item
            ...
            ><div class="overview-time">
              ...
              <template v-else-if="timeType === 'preset'"
                ...
                {{ formData.days }}
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-110") }}</template
              >
              <template v-else-if="timeType === 'custom' && dateRange"
                >{{ dateRange[0] }}
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-111") }}
              ...
              <template
                ...
                "
                >{{ formData.yearRange[0] }}
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-112") }}
                {{ formData.yearRange[1] }}
                {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-113") }}</template
              >
            </div></el-descriptions-item
          >
          <el-descriptions-item
            ...
            <div v-if="formData.resume">
              {{ $t("tasks-FeedIndexTask-19c298e1d0a206148-119") }}
              {{ formData.taskId }}
            </div></el-descriptions-item
          ></el-descriptions
        >
      ...
      <template #footer
        ><span class="dialog-footer"
          ><el-button @click="taskOverviewDialogVisible = false">{{
            $t("tasks-FeedIndexTask-19c298e1d0a206148-120")
          }}</el-button>
          <el-button
            type="primary"
            @click="confirmSubmitTask"
            :loading="submitting"
            >{{ $t("tasks-FeedIndexTask-19c298e1d0a206148-121") }}</el-button
          ></span
        ></template
      ></el-dialog
    >
...
// 优先级标记
const priorityMarks = {
  1: t("tasks-FeedIndexTask-19c298e1d0a206148-122"),
  5: t("tasks-FeedIndexTask-19c298e1d0a206148-123"),
  10: t("tasks-FeedIndexTask-19c298e1d0a206148-124"),
};
...
const fetchCityMap = async () => {
  try {
    ...
    console.error(
      t("tasks-FeedIndexTask-19c298e1d0a206148-125"),
      error,
    );
  }
};
...
const checkKeywords = async () => {
  if (formData.keywords.length === 0) {
    ElMessage.warning(
      t("tasks-FeedIndexTask-19c298e1d0a206148-126"),
    );
    return;
  }
  ...
  try {
    ...
    if (response.data.code === 10000) {
      ...
      ElMessage.error(
        `${t("tasks-FeedIndexTask-19c298e1d0a206148-127")}${response.data.msg}`,
      );
    }
  } catch (error) {
    console.error(
      t("tasks-FeedIndexTask-19c298e1d0a206148-128"),
      error,
    );
    ElMessage.error(t("tasks-FeedIndexTask-19c298e1d0a206148-129"));
  } finally {
...
const addBatchKeywords = () => {
  ...
  if (addedCount > 0) {
    ElMessage.success(
      `${t("tasks-FeedIndexTask-19c298e1d0a206148-130")}${addedCount}${t("tasks-FeedIndexTask-19c298e1d0a206148-131")}`,
    );
  }

  if (duplicateCount > 0) {
    ElMessage.warning(
      `${duplicateCount}${t("tasks-FeedIndexTask-19c298e1d0a206148-132")}`,
    );
  }
...
const clearKeywords = () => {
  ElMessageBox.confirm(
    t("tasks-FeedIndexTask-19c298e1d0a206148-133"),
    t("tasks-FeedIndexTask-19c298e1d0a206148-134"),
    {
      confirmButtonText: t(
        "tasks-FeedIndexTask-19c298e1d0a206148-135",
      ),
      cancelButtonText: t(
        "tasks-FeedIndexTask-19c298e1d0a206148-136",
      ),
      type: "warning",
    },
  )
...
const removeInvalidKeywords = () => {
  ...
  ElMessageBox.confirm(
    t("tasks-FeedIndexTask-19c298e1d0a206148-137"),
    t("tasks-FeedIndexTask-19c298e1d0a206148-138"),
    {
      confirmButtonText: t(
        "tasks-FeedIndexTask-19c298e1d0a206148-139",
      ),
      cancelButtonText: t(
        "tasks-FeedIndexTask-19c298e1d0a206148-140",
      ),
      type: "warning",
    },
  )
    .then(() => {
      ...
      if (invalidKeywords.length > 0) {
        ElMessage.success(
          `${t("tasks-FeedIndexTask-19c298e1d0a206148-141")}${invalidKeywords.length}${t("tasks-FeedIndexTask-19c298e1d0a206148-142")}`,
        );
      }
    })
    .catch(() => {});
...
const removeInvalidKeywordsFromDialog = () => {
  ...
  if (invalidKeywords.length > 0) {
    ElMessage.success(
      `${t("tasks-FeedIndexTask-19c298e1d0a206148-143")}${invalidKeywords.length}${t("tasks-FeedIndexTask-19c298e1d0a206148-144")}`,
    );
...
const handleKeywordsFileChange = async (file: any) => {
  ...
  try {
    ...
    if (keywords.length === 0) {
      ElMessage.warning(
        t("tasks-FeedIndexTask-19c298e1d0a206148-145"),
      );
      return;
    }
    ...
    console.error(
      t("tasks-FeedIndexTask-19c298e1d0a206148-147"),
      error,
    );
    ElMessage.error(t("tasks-FeedIndexTask-19c298e1d0a206148-148"));
  }
};
...
const handleCitiesFileChange = async (file: any) => {
  ...
  try {
    ...
    if (cityCodes.length === 0) {
      ElMessage.warning(
        t("tasks-FeedIndexTask-19c298e1d0a206148-149"),
      );
      return;
    }
    ...
    console.error(
      t("tasks-FeedIndexTask-19c298e1d0a206148-151"),
      error,
    );
    ElMessage.error(t("tasks-FeedIndexTask-19c298e1d0a206148-152"));
  }
};
...
const readFileContent = (
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onerror = () => {
      reject(
        new Error(t("tasks-FeedIndexTask-19c298e1d0a206148-153")),
      );
    };
...
const submitTask = async () => {
  ...
  try {
    ...
    if (response.data.code === 10000) {
      ...
      ElMessage.error(
        `${t("tasks-FeedIndexTask-19c298e1d0a206148-154")}${response.data.msg}`,
      );
    }
  } catch (error) {
    ElMessage.error(t("tasks-FeedIndexTask-19c298e1d0a206148-155"));
    console.error(
      t("tasks-FeedIndexTask-19c298e1d0a206148-156"),
      error,
    );
  } finally {
