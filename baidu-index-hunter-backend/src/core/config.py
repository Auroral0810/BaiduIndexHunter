...
SPIDER_CONFIG = {
    ...
    'max_consecutive_failures': int(os.getenv('SPIDER_MAX_CONSECUTIVE_FAILURES', 3)),  # 最大连续失败次数
    'failure_multiplier': float(os.getenv('SPIDER_FAILURE_MULTIPLIER', 1.2)),  # 失败后等待时间倍数，降低到1.1
