...
# 请求示例和参数如下：
wordlist = ['电脑', '衣服', '手机']
url = f'{BAIDU_INDEX_API["social_api_url"]}?wordlist[]={wordlist[0]}&wordlist[]={wordlist[1]}&wordlist[]={wordlist[2]}'
headers = {
...
def parse_social_attributes(response_json):
    """
    解析百度指数人群画像的人群属性数据
...
if response.status_code == 200:
    try:
        ...
        parse_social_attributes(result)
    except Exception as e:
