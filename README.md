...
个人学习与技术研究项目 - 基于 Scrapy 框架的百度指数数据采集工具
...
>
> - 使用本工具进行数据采集时，请遵守相关法律法规及百度的服务条款
> - 如因使用本工具产生的任何法律责任或后果，由使用者自行承担，本项目作者概不负责
> - 本项目为**非开源、非商用**的个人项目，请勿将其用于任何盈利目的
> - 本项目仅用于学习爬虫技术、数据分析和软件架构等技术知识

---

## 项目简介

BaiduIndexHunter 是一个用于学习爬虫技术和数据分析的个人项目，采用 Scrapy 框架实现百度指数数据采集，支持多种数据类型的批量采集、断点续传、实时进度监控等功能。
